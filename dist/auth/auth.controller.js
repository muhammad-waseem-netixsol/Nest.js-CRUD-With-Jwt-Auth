...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "THIS SIGNS YOU UP" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "SIGNING USER IN" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "SUCCESSFULL" }),
    (0, swagger_1.ApiResponse)({ status: 404, description: "BAD REQUEST" }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_auth_dto_1.CreateLoginDto]),
    __metadata("design:returntype", void 0)
